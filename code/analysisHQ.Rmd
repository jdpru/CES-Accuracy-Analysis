...
The above accurac functions measure error where the unit of observation is the state. This function treats the country as the unit of observation, so there's just one error per variable per year (x the number of categories for that variable)
