...
# cps_artifact_dir <- "/Users/jdpruett/Desktop/CES Accuracy Analysis/data/IPUMS CPS Artifacts"
...
vars_used_ces_weights <- list(
  ...
  `2018` = c("AGE_GROUP_rc", "EDUC_rc", "SEX_rc", "HISPAN_rc", "VOTEREG_rc", "POST_STATE_rc", "GOV_CANDIDATE_rc", "GOV_PARTY_rc", "SENATOR_CANDIDATE_rc", "SENATOR_PARTY_rc"),
  `2020` = c("AGE_GROUP_rc", "EDUC_rc", "SEX_rc", "HISPAN_rc", "VOTEREG_rc", "POST_STATE_rc", "GOV_CANDIDATE_rc", "GOV_PARTY_rc", "SENATOR_CANDIDATE_rc", "SENATOR_PARTY_rc", "PRES_PARTY_rc", "PRES_CANDIDATE_rc"),
  `2022` = c("AGE_GROUP_rc", "EDUC_rc", "SEX_rc", "HISPAN_rc", "VOTEREG_rc", "POST_STATE_rc", "GOV_CANDIDATE_rc", "GOV_PARTY_rc", "SENATOR_CANDIDATE_rc", "SENATOR_PARTY_rc"
  )
)
```
