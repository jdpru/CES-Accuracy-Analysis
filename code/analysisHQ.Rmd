...
# export to excel sorted by Matching score
...
# Calculate Summary Statistics and Export Tables
```{r}
# ==============================================================================
...
# Useful for exploratory analysis and comparing all variables/weighting methods
...
# ==============================================================================
# FILTERED TABLES FOR ACCURACY ASSESSMENT
# ==============================================================================
# IMPORTANT: For unbiased accuracy assessment, use Valid_for_Accuracy filter
# This ensures variables were not used in EITHER CES or ANESRake weighting
#
# Valid_for_Accuracy = TRUE means:
#   - Variable_Type == "Secondary" (not used in CES weighting) AND
#   - Used_in_ANESRake_Weighting == FALSE (not used in ANESRake)

# RMSE by Year × Variable × Weighting Method (Valid_for_Accuracy only)
...
# ---------------------------------------------------------------
# 2. Distribution of errors (error buckets)
# ---------------------------------------------------------------

dist_errors_bucket_table <- most_specific_long %>%
  mutate(
    Abs_Error = abs(Error),
    Error_Bucket = cut(
      Abs_Error,
