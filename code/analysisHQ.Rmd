...
# ==============================================================================
# Output Tables for Figures Analysis
# ==============================================================================
...
```{r}
# ==============================================================================
# FILTERING FOR ACCURACY ASSESSMENT
# ==============================================================================
...
valid_accuracy_rmse <- most_specific_long %>%
...
# Alternative: Filter to Secondary only (may include ANESRake-weighted vars)
# Less strict - includes variables not used in CES weighting but may have been
# used in ANESRake weighting
secondary_only_rmse <- most_specific_long %>%
  filter(Variable_Type == "Secondary") %>%
  group_by(Year, Variable, Weighting_Method) %>%
  summarise(
...
# ---------------------------------------------------------------
# Big overall summary table: Rows = years, Columns = variables, Values = RMSE
# ---------------------------------------------------------------
...
# ---------------------------------------------------------------
# Distribution of errors (error buckets)
# ---------------------------------------------------------------
