...
```{r}
###### 
# NOTE TO USER: The CES often updates metadata and changes the filename on the Dataverse, you will likely need to update the file names below to whatever they are when you download them.
######
...
State_legislative_0623 <- State_legislative_0623_raw %>%
  anti_join(
    special_candidates_to_remove %>%
      filter(concurrent_special != TRUE),
