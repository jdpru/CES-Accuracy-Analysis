...
\toprule
& \multicolumn{5}{c}{Winner's Vote Share (\%)} \\
\cmidrule(lr){2-6}
Min. Respondents & 20--40 & 40--60 & 60--80 & 80--90 & 90--100 \\
\midrule
\multicolumn{6}{l}{\textit{RMSE (\%)}} \\
\addlinespace[0.2em]
...
\midrule
\multicolumn{6}{l}{\textit{Number of District-Years}} \\
\addlinespace[0.2em]
